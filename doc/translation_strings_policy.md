...
This document provides guidelines for internationalization of the Adevplus20 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `adevplus20_en.ts` remains unchanged.
