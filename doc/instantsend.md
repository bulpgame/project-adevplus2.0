...
This mechanism has been integrated into Bitcore-Node-Adevplus20 which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/adevplus20pay/insight-api-adevplus20#web-socket-api](https://github.com/adevplus20pay/insight-api-adevplus20#web-socket-api)
* API: [https://github.com/adevplus20pay/insight-api-adevplus20#instantsend-transactions](https://github.com/adevplus20pay/insight-api-adevplus20#instantsend-transactions)
...
By default, the Adevplus20 Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Adevplus20 Core daemon:
