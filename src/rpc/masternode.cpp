...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_26000);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Adevplus20 address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "adevplus20",               "masternode",             &masternode,             true,  {} },
    { "adevplus20",               "masternodelist",         &masternodelist,         true,  {} },
    { "adevplus20",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "adevplus20",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "adevplus20",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "adevplus20",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
