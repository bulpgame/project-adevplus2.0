...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in adevplus20.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("adevplus20.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Adevplus20 features */
    { "adevplus20",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "adevplus20",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "adevplus20",               "gobject",                &gobject,                true,  {} },
    { "adevplus20",               "voteraw",                &voteraw,                true,  {} },
