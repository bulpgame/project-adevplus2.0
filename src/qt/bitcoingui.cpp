...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Adevplus20 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adevplus20: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about Adevplus20 Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Adevplus20 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Adevplus20 addresses"));
    ...
    openAction->setStatusTip(tr("Open a adevplus20: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Adevplus20 command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Adevplus20 network", "", count));
    } else {
...
{
    QString strTitle = tr("Adevplus20 Core"); // default title
    ...
    // Append title to "Adevplus20 Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
