    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ADV2-light"), QVariant("light"));
    ui->theme->addItem(QString("ADV2-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ADV2-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ADV2-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ADV2-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ADV2-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ADV2-traditional"), QVariant("trad"));
