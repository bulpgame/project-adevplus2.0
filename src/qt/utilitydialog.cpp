    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  adevplus20-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Adevplus20 in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ADV2, 0.1 ADV2, 1 ADV2 and 10 ADV2 -- sort of like the paper money you use every day.</li> \
