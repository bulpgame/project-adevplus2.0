...
2. run adevplus20d with -printalert or -sendalert like this:
   /path/to/adevplus20d -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.adevplus20.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Adevplus20 Core:0.12.0.58/"));
