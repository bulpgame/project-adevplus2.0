...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 ADV2 from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ADV2 in block rewards plus fees, but
        ...
        # Send 100 ADV2 with subtract fee from amount
        ...
        # Sendmany 100 ADV2 with subtract fee from amount
