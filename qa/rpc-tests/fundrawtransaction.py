...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid adevplus20 address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid adevplus20 address" in e.error['message'])
